...
const config_map RegistrationConfig::default_config = {
    {"verbose", "false"}, {"registered", "registered"}, {"map", "map"}};

const std::vector<std::string> RegistrationConfig::required_options = {"fixed", "moved",
                                                                       "nodespacing"};

const std::vector<std::string> RegistrationConfig::arg_options = {"fixed", "moved", "mask",
                                                                  "nodespacing"};

const std::vector<std::string> RegistrationConfig::bool_options = {"verbose"};
